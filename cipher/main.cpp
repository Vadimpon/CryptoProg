...
int main() {
    ...
    if (mode == "encrypt") {
        ...
        if(input_file_string == "default")  
           input_file_string = "/home/stud/CryptoProg/cipher/test1";
        ...
        if(output_file_string == "default")
            output_file_string = "/home/stud/CryptoProg/cipher/encrypted_text";
        ...
        StringSource(pass, true, 
        			new HexEncoder( 
        			new ArraySink(pass_b, sizeof(pass_b))));
        ...
        cin >> input_file_string;
        if(input_file_string == "default")
            input_file_string = "/home/stud/CryptoProg/cipher/encrypted_text";
        ifstream input_check(input_file_string);
        if(input_check.is_open() == 0) {
        ...
        cin >> output_file_string;
        if(output_file_string == "default")
            output_file_string = "/home/stud/CryptoProg/cipher/decrypted_text";
        ifstream output_check(output_file_string);
        if(output_check.is_open() == 0) {
